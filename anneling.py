...
# FIXME: Add function to adjust the rate of case >= 6 inorder to solve too easy puzzle 
...
def solve(board, ite, current_error):
    ...
    EPSILON = math.exp(
        float(-deltaE / float((ite % max_iter if (ite % max_iter != 0) else max_iter - 1) * 0.00005))
    )
